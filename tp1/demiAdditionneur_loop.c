/********
* ec2c version 0.68
* c main file generated for node : demiAdditionneur 
* to be used with : demiAdditionneur.c 
* and             : demiAdditionneur.h 
* context   method = HEAP
...
/* Output procedures **********************/
#ifdef CKCHECK
void demiAdditionneur_BOT_cy(void* cdata){
   _put_bottom("cy");
}
void demiAdditionneur_BOT_sum(void* cdata){
   _put_bottom("sum");
}
#endif
/* Output procedures **********************/
void demiAdditionneur_O_cy(void* cdata, _boolean _V) {
   _put_bool("cy", _V);
}
void demiAdditionneur_O_sum(void* cdata, _boolean _V) {
   _put_bool("sum", _V);
}/* Main procedure *************************/
int main(){
   ...
   int s = 0;
   /* Context allocation */
   struct demiAdditionneur_ctx* ctx = demiAdditionneur_new_ctx(NULL);
   ...
   while(1){
      ...
      fflush(stdout);
      ++s;
      demiAdditionneur_I_a(ctx, _get_bool("a"));
      demiAdditionneur_I_b(ctx, _get_bool("b"));
      demiAdditionneur_step(ctx);
